...
## Steps
1. Read `.claude/workflows/governance.md` (SemVer table, contribution workflow, deprecation policy, change comms).
...
4. For a **deprecation**: mark with reason + replacement + removal version; keep working ≥ 1 minor cycle; provide a migration map (`.claude/design-systems/crosswalk.md` style); remove only in a major.
