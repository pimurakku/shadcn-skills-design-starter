...
## Steps
1. Read `.claude/accessibility/wcag-checklist.md` (POUR-organized, P0/P1/P2) and `.claude/accessibility/aria-patterns.md`.
...
5. Check reduced-motion handling (`.claude/taste/motion-choreography.md`).
