...
## Steps
1. Read `.claude/workflows/prototyping.md` (5-level fidelity ladder, journey mapping template, usability-testing script, sample data).
...
5. High-fi/code steps pull tokens (`.claude/tokens/*`), components (`.claude/components/*`), taste (`.claude/taste/*`), and a11y (`.claude/accessibility/*`).
