...
## Steps
1. Read `.claude/workflows/design-review.md` (rubric, scoring guide, Nielsen heuristics, process).
...
4. Run the accessibility lens with `.claude/accessibility/wcag-checklist.md`; use `scripts/contrast.py` for any color-pair doubts.
5. Check against the anti-slop tells in `.claude/taste/design-taste.md` (Banned Defaults checklist).
